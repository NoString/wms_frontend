...
export default () =>{
    ...
    const getBottom = async () => {
        ...
        let result = await ajax("/common/wmsTailOutRecord/weekCount",null, "g");
    ...
    const getLeftPie = async () => {
        ...
        let result = await ajax("/common/wmsTailOutRecord/classifyCount",null, "g");
    ...
    const getRightPie = async () => {
        ...
        let result = await ajax("/common/wmsTailOutRecord/userCount",null, "g");
